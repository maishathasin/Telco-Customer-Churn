...
Our second model is a simple SVM that uses 90% of the pre-processed dataset to train the SVM classifier from scikit-learn. We fit the model on 4 different SVM models with different hyperparamters
```{r table2, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl <- "
| Tables        | Regulization parameter | Kernal  | accuracy|
|---------------|:-------------:|------:|------:|
...
## Code
Below is the code for the Decision Tree shown above. 
...
Below is the code for the SVM described above.
```{python, eval=FALSE, echo=TRUE, python.reticulate=FALSE}
import pandas as pd
import matplotlib.pyplot as plt
import numpy as np
