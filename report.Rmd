...
The vast majority of these analyses are plug-and-play, where default classifiers are run on the dataset, and then the results are analyzed and visualized in many ways. The analyses also seem to be mainly focused on visualizating the data and building a single model, rather than comparing different models and preprocessing methods like we have done.
