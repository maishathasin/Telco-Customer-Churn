...
Logistic regression & 0.84 & 0.89 & 0.65 & 0.88 & penalty = l1 ,C = 1\\
...
-light weight model 
-performs well cause the dataset is not very complicated and we also reduce the number of features 
